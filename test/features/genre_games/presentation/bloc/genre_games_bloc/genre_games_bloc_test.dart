...
void main() {
  ...
  final testModel = [
    GenreGameModel(name: 'Cyberpunk 2077', popularity: 1, url: 'url', gameId: 1),
    GenreGameModel(name: 'The Witcher 3: Wild Hunt', popularity: 1, url: 'url', gameId: 1),
  ];

  test('should correctly add games to sink and obtain them in [GenreGamesState]', () {
    when(
      () => genreGamesRepository.getGameModels(genreId: 1, page: 1),

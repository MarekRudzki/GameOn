...
import 'package:gameon/features/game_details/presentation/widgets/available_platforms.dart';
import 'package:gameon/features/game_details/presentation/widgets/custom_sliver_app_bar.dart';
import 'package:gameon/features/game_details/presentation/widgets/game_description.dart';
import 'package:gameon/features/game_details/presentation/widgets/game_screenshots.dart';
import 'package:gameon/features/game_details/presentation/widgets/overall_game_info.dart';
import 'package:gameon/features/game_details/presentation/widgets/user_rating.dart';
          ...
          body: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Color.fromARGB(255, 2, 28, 61), Color.fromARGB(255, 31, 71, 126)],
              ),
            ),
                          ...
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                AvailablePlatforms(platforms: state.gameDetails.platforms),
                                GameDescription(description: state.gameDetails.description),
                                if (state.gameDetails.screenshots == ['No Data'])
                                  const SizedBox.shrink()
                                else
                                  GameScreenshots(screenshots: state.gameDetails.screenshots),
                              ],
                            ),
                          );
                        } else {

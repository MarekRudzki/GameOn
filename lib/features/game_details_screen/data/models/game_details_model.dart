...
class GameDetailsModel extends Equatable {
  ...
  factory GameDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    final platforms = listDynamic.map((e) => e as Map<String, dynamic>).toList();
    ...
    final screenshots = screenshotListDynamic.map((e) => e as Map<String, dynamic>).toList();
    ...
    return GameDetailsModel(
      ...
      developers: json['developers'] != null
          ...
          : 'No Data',
      esrbRating: json['esrb_rating'] != null ? json['esrb_rating']['name'] as String : 'No Data',
      ...
      released: json['released'] != null ? json['released'] as String : 'No Data',
      reviewsCount: json['reviews_count'] != null ? json['reviews_count'] as int : 0,
      screenshots: json['results'] != null ? screenshotsList : ['No Data'],
      userRating: json['ratings'] != null
          ? UserRatingModel.fromJsonList(
              (json['ratings'] as List<dynamic>).map((e) => e as Map<String, dynamic>).toList(),
            )
